...
def network_model(data, labels, scale_size, *, patch_size=(20, 20, 5)):
    ...
    dens1 = dense_layer('dense1', pool3_flat, phase, num_neurons=32, activation_fun=tf.nn.relu)
    dens2 = dense_layer('dense2', dens1, phase, num_neurons=32, activation_fun=tf.nn.relu)
